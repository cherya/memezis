...
func (s *store) vote(ctx context.Context, postID int, userID string, isUp bool) (*VotesCount, error) {
...
func (s *store) UpVote(ctx context.Context, postID int, userID string) (*VotesCount, error) {
...
func (s *store) DownVote(ctx context.Context, postID int, userID string) (*VotesCount, error) {
